    ...
    public void sendErrorMail(final StringBuilder errorContent) {
        ...
        new Thread() {
            ...
            public void run() {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                Intent sendIntent = new Intent(
                                        Intent.ACTION_SEND);
                                String subject =  context.getString(R.string.text_email_crash);
                                ...
                                sendIntent.putExtra(Intent.EXTRA_EMAIL,
                                        new String[] { context.getString(R.string.email_crash) });
                ...
                builder.setMessage(context.getString(R.string.text_error));
                builder.show();
                Looper.loop();
            }
        }.start();
